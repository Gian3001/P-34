...
function setup() {
  ...
  rope1 = new Rope(hero.body, { x: 500, y: 50 });
  ...
  box15 = new Box(700, 250, 70, 70);
  box16 = new Box(700, 300, 70, 70);
  box17 = new Box(700, 350, 70, 70);
  box18 = new Box(700, 400, 70, 70);

  box19 = new Box(800, 100, 70, 70);
  box20 = new Box(800, 100, 70, 70);
  box21 = new Box(800, 150, 70, 70);
  box22 = new Box(800, 200, 70, 70);
  box23 = new Box(800, 250, 70, 70);
  box24 = new Box(800, 300, 70, 70);
  box25 = new Box(800, 350, 70, 70);
  box26 = new Box(800, 400, 70, 70);
}
